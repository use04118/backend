...
def send_purchase_email(recipient_email, purchase_pdf_path, purchase_no, business_name=None, party_name=None):
    subject = f'Purchase #{purchase_no} from {business_name or "Your Company"}'
    message = f'''
Dear {party_name or "Valued Customer"},

Thank you for your business with {business_name or "our company"}. Please find attached the purchase #{purchase_no} for your recent purchase.
...
def send_debitnote_email(recipient_email, debitnote_pdf_path, debitnote_no, business_name=None, party_name=None):
    subject = f'debitnote #{debitnote_no} from {business_name or "Your Company"}'
    message = f'''
Dear {party_name or "Valued Customer"},

Thank you for your business with {business_name or "our company"}. Please find attached the invoice #{debitnote_no} for your recent purchase.

debit_note Details:
- debitnote Number: {debitnote_no}
- Date: {datetime.now().strftime("%d-%m-%Y")}
- Customer Name: {party_name or "N/A"}
