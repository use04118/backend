...
# def recalculate_party_closing_balance(party):
#     # Sum total_amount of all invoices for the party
#     invoices_total = party.invoice.aggregate(total=Sum('total_amount'))['total'] or 0
#     party.closing_balance = invoices_total
#     party.save()

# @receiver(post_save, sender=Invoice)
# @receiver(post_delete, sender=Invoice)
# def update_party_closing_balance_from_invoice(sender, instance, **kwargs):
#     if instance.party:
#         recalculate_party_closing_balance(instance.party)